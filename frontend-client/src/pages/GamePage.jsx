...
const styles = navalBase + `
  ...
  .game-btn:hover { background:linear-gradient(135deg,#1d4ed8,#1e40af); transform:scale(1.04); }
  ...
  .game-message-dot--hit  { background:#22c55e!important; box-shadow:0 0 10px rgba(34,197,94,0.7)!important; }
  .game-message-dot--miss { background:#94a3b8!important; box-shadow:none!important; animation:none!important; }
...
export default function GamePage() {
    ...
    // Llamado por el WinOverlay cuando termina la cuenta atrás
    const handleGameWon = () => {
        navigate('/ranking');
    };

    // Clase del dot según el último mensaje
    const dotClass = message.includes('💥') || message.includes('🚢')
        ? 'game-message-dot game-message-dot--hit'
        : message.includes('💧')
            ? 'game-message-dot game-message-dot--miss'
            : 'game-message-dot';
                    ...
                    {!gameId ? (
                        <div className="game-start-wrap">
                            ...
                            <div style={{ textAlign:'center' }}>
                                <h2 className="game-start-title">
                                    ¡Zarpa a <span>rescatar</span> la flota!
                                </h2>
                                <p className="game-start-sub" style={{ marginTop:'0.75rem' }}>
                                    Localiza y rescata todos los barcos perdidos en el océano.
                                </p>
                            </div>
                        ...
                        <div className="game-active-wrap">
                            ...
                            {!gameWon && (
                                <div className="game-actions">
                                    ...
                                    <Link to="/ranking" className="game-btn game-btn--ghost">
                                        🏆 Ver Ranking
                                    </Link>
                                </div>
                            )}
